$(document).ready(function () {
  $('#organizationListDataTable').DataTable({
    ajax: {
      url: '/baseInformation/organization/masterData/api/getData',
      dataSrc: ''
    },
    columns: [
      {
      ...
      { data: 'registerNo' },
      { data: 'province.title' },
      { data: 'organizationType.title' },
      { data: 'organizationCategory.title' },
      { data: 'creator.fullName' },
      {
        ...
        render: function (data, type, row) {
          ...
          <div class="row-table text-center">
            ...
            <a class="edit button button-box button-xs button-info" href="/baseInformation/organization/masterData/edit/${row.id}">
              <i class="zmdi zmdi-edit"></i>
            </a>
            <a class="delete button button-box button-xs button-danger" href="/baseInformation/organization/masterData/delete/${row.id}" onclick="return confirm('آیا از عملیات حذف مطمين هستید؟');" >
